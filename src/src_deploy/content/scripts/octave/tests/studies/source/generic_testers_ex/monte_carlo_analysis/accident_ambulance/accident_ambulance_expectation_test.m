classdef accident_ambulance_expectation_test < ee_solns_demos.testers.d_20170204_2252.GenericTesterWOpts
%{
/*
...
%              import ee_solns_demos.testers.d_20170204_2252.*
            
            opts = ee_solns_demos.testers.d_20170204_2252.tester_options_set;

            opts.title = 'Expected Accident-to-Ambulance Distance on a Road of Length L';
            opts.description = ...
                { ...
...
%              opts.flag_expected_to_fail = 0;
            ...
            obj@ee_solns_demos.testers.d_20170204_2252.GenericTesterWOpts( opts );
        end
